...
class FuelRequest extends Model {
    ...
    public function statusLabel(): string
    {
        return match ($this->status) {
            self::STATUS_OTP_VERIFICATION => 'Handoff Verification',
    ...
    public function hasDeliveryHandoffToken(): bool
    {
        return $this->delivery_handoff_token !== null && $this->delivery_handoff_token !== '';
    }
    ...
    public function deliveryHandoffQrPayload(): ?string
    {
        if (! $this->hasPendingDeliveryOtp() || ! $this->hasDeliveryHandoffToken()) {
            return null;
        }
        ...
        return implode('|', [
            'FM-HANDOFF',
            (string) $this->getKey(),
            (string) $this->delivery_handoff_token,
        ]);
    }
