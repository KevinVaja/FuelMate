...
<div class="d-flex justify-content-between align-items-center gap-3 flex-wrap mb-4">
  ...
  <div class="d-flex gap-2">
    ...
    <a href="{{ route('orders.invoice.download', $order->id) }}" class="btn btn-primary"><i class="fas fa-download me-2"></i>Download Invoice</a>
    <button type="button" class="btn btn-outline-primary" onclick="window.print()"><i class="fas fa-print me-2"></i>Print</button>
  </div>
</div>
  ...
  <div class="col-lg-4">
    ...
    <div class="card border-primary border-opacity-25 bg-primary bg-opacity-10">
      <div class="card-body">
        ...
        <div class="small text-muted mb-0">For COD orders, payment status turns paid after customer-verified delivery handoff.</div>
      </div>
    </div>
  </div>
</div>
