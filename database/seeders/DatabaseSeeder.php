...
class DatabaseSeeder extends Seeder {
    public function run(): void {
        // Admin
        $admin = User::create(['name'=>'Admin User','email'=>'admin@fuelmate.com','email_verified_at'=>now(),'phone'=>'9000000001','password'=>Hash::make('admin123'),'role'=>'admin','status'=>'active']);

        // Agent user
        $agentUser = User::create(['name'=>'Ravi Kumar','email'=>'agent@fuelmate.com','email_verified_at'=>now(),'phone'=>'9000000002','password'=>Hash::make('agent123'),'role'=>'agent','status'=>'active']);
        $agent = Agent::create([
        ...
        // Extra users
        User::create(['name'=>'Amit Singh','email'=>'amit@example.com','email_verified_at'=>now(),'phone'=>'9000000004','password'=>Hash::make('password'),'role'=>'user']);
